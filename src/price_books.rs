...
use crate::{client::{create_jwt, Client}, price_book::PriceBook};
...
impl PriceBooks {
    pub async fn get_best_bid_ask(client: &Client<'_>, product_ids: Option<Vec<&str>>) -> Result<PriceBooks, reqwest::Error> {
